...
export const STATE_REQUIREMENTS = {
  ...
  MN: { name: 'Minnesota', totalHours: 40, nightHours: 15, note: '+10 hours unless a parent completes a teen-driver course.' },
  MS: { name: 'Mississippi', totalHours: 0, nightHours: 0 },
